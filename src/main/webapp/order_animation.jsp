...
<body>
	...
	<%
	  	int orderNumber = (Integer)session.getAttribute("orderNumber");
	...
	class OrderSuccessAnimation {
	    ...
	    init() {
	        ...
	        this.container.innerHTML = `
	            ...
	            <button class="continue-button" onclick="window.location.href='User/user_homepage.jsp'">
	                Continue Shopping
	            </button>
	        `;
	    ...
	    show(orderDetails) {
	        // Set order details
	        document.getElementById('orderNumber').textContent = `#1234${orderDetails.orderNumber}`;
	...
	<script>
            ...
            // Define the OrderSuccessAnimation class here or link the external script if it’s already defined
            ...
            document.addEventListener("DOMContentLoaded", function() {
			    ...
			    const orderDetails = { orderNumber, address };
			
			    const orderSuccess = new OrderSuccessAnimation();
			    orderSuccess.show(orderDetails);
			});
