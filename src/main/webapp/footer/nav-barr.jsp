...
<!-- <nav class="navbar">
    <div class="nav-brand">
        <a href="restaurant.jsp" style="text-decoration: none;"><h1 class="appname">Tap <i class="fa-solid fa-hand-point-up"></i> Foods</h1></a>
    </div>
    ...
    <div class="nav-right">
        <div class="user-info">
            ...
            <div class="user-menu">
                <a href="profile.jsp" class="user-menu-item">
	...
	<div class="nav-right">
		<div class="user-info">
			<%
				...
				// Correct the way the parameters are passed to the getUser method
